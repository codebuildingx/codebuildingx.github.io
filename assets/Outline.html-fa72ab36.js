...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="类和对象篇" tabindex="-1"><a class="header-anchor" href="#类和对象篇" aria-hidden="true">#</a> 类和对象篇</h2><h3 id="构造函数是否可以是虚函数" tabindex="-1"><a class="header-anchor" href="#构造函数是否可以是虚函数" aria-hidden="true">#</a> 构造函数是否可以是虚函数?</h3><p>虚函数的调用是通过虚函数表来查找的，而虚函数表由类的实例化对象的vptr指针指向，该指针存放在对象的内部空间中，需要调用构造函数完成初始化。如果构造函数是虚函数，那么调用构造函数就需要去找vptr，但此时vptr还没有初始化。构造函数将无法调用。</p><h3 id="析构函数是否可以是虚函数" tabindex="-1"><a class="header-anchor" href="#析构函数是否可以是虚函数" aria-hidden="true">#</a> 析构函数是否可以是虚函数?</h3><p>与构造函数不同，vptr已经完成初始化，析构函数可以声明为虚函数，且类有继承时，析构函数常常必须为虚函数。</p><h3 id="构造函数是否可以抛出异常" tabindex="-1"><a class="header-anchor" href="#构造函数是否可以抛出异常" aria-hidden="true">#</a> 构造函数是否可以抛出异常?</h3><p>可以， 但不建议。</p><h3 id="析构函数是否可以抛出异常" tabindex="-1"><a class="header-anchor" href="#析构函数是否可以抛出异常" aria-hidden="true">#</a> 析构函数是否可以抛出异常?</h3><p>C++允许在析构函数中抛出异常， 但是并不推荐在析构函数中抛出异常。</p><p>在析构函数中抛出异常，可能会出现下面的问题：</p><p>（1）对象正常结束，在析构时，触发析构函数中的异常，打印异常信息，退出。在这种情况下，抛出异常并没有什么问题，析构函数的异常会被外面捕获；当然，如果外面的程序没有继续释放剩余的资源，可能会造成内存泄露。</p><p>（2）对象离开作用域之前，抛出异常，此时会调用析构函数，析构函数再抛出异常，此时之前的异常就不能被捕获了，而且会造成程序crash。</p><p>因此尽可能不让异常逃离析构函数, 可以用try catch吞掉异常。</p><h3 id="如何禁用拷贝构造函数" tabindex="-1"><a class="header-anchor" href="#如何禁用拷贝构造函数" aria-hidden="true">#</a> 如何禁用拷贝构造函数</h3><ul><li><p>如果你的编译器支持 C++11，直接使用 delete</p></li><li><p>可以把拷贝构造函数和赋值操作符声明成private同时不提供实现。</p></li><li><p>可以通过一个基类来封装第二步，因为默认生成的拷贝构造函数会自动调用基类的拷贝构造函数，如果基类的拷贝构造函数是private，那么它无法访问，也就无法正常生成拷贝构造函数。</p></li></ul><h3 id="const成员方法中如果要修改成员变量的值-要怎么做" tabindex="-1"><a class="header-anchor" href="#const成员方法中如果要修改成员变量的值-要怎么做" aria-hidden="true">#</a> const成员方法中如果要修改成员变量的值，要怎么做？</h3><ul><li>方法1：使用mutable关键字</li></ul><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;iostream&gt;</span></span>
<span class="token keyword">using</span> <span class="token keyword">namespace</span> std<span class="token punctuation">;</span>

...
size: 15
capacity: 15
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>reserve</strong>:</p><p>reserve(n)</p><p>n大于当前容器的capacity时，会改变容器的capacity。这个过程只是分配空间， 不负责构建内容。</p><p>当n小于或者等于当前容量时，reserve什么也不做。</p><h3 id="deque容器的原理" tabindex="-1"><a class="header-anchor" href="#deque容器的原理" aria-hidden="true">#</a> deque容器的原理</h3>`,88),o=[e];function c(l,i){return s(),a("div",null,o)}const r=n(p,[["render",c],["__file","Outline.html.vue"]]);export{r as default};
